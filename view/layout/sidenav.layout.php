    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li><a href="<?= URL_ROOT.'/home/';?>" data-toggle="tooltip" data-placement="right" data-i18n="[title]layout.sidebar.title.1"><i class="fa fa-th-large fa-fw"></i> <span class="nav-label"></span></a></li>
                <li><a href="<?= URL_ROOT.'/ticket/';?>" data-toggle="tooltip" data-placement="right" data-i18n="[title]layout.sidebar.title.2"><i class="fa fa-ticket fa-fw"></i> <span class="nav-label"></span></a></li>
                <li><a href="<?= URL_ROOT.'/tools/';?>" data-toggle="tooltip" data-placement="right" data-i18n="[title]layout.sidebar.title.3"><i class="fa fa-wrench fa-fw"></i> <span class="nav-label"></span></a></li>
				<li><a href="<?= URL_ROOT.'/user/';?>" data-toggle="tooltip" data-placement="right" data-i18n="[title]layout.sidebar.title.4"><i class="fa fa-user fa-fw"></i> <span class="nav-label"></span></a></li>
