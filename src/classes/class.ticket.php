	...
	class Ticket {
		...
		public function getTable(){
			...
			$columns = array(  
				...
				array ('db' => "ticket_customer_serviceid", 		'dt' => 3),
				array ('db' => "ticket_service", 			'dt' => 4),
				array ('db' => "ticket_extern", 			'dt' => 5),
				array (
					'db' => "ticket_failure", 			
					'dt' => 6,
					'formatter' => function($d,$row){
				...
				array ('db' => "ticket_external_ticket_nr", 			'dt' => 7),
				array ('db' => "ticket_created_date", 	'dt' => 8),
				...
				array ('db' => "ticket_submit_again", 'dt' => 10),	
				array ('db' => "ticket_planned", 'dt' => 11)	
			);
