...
class Tools
{
    ...
    protected $defaults = array('host' => '', 'user' => 'PreProcessor', 'pass' => 'ikhouvanjou', 'db' => 'scs_stat');
    ...
    public function getPortMonitor()
    {
        ...
        $blocks_asb .= $this->getPortMonitorBlock('BW ASB (EHV)', array(
            'host' => '10.53.183.101'
        ));
        //$blocks_asb .= $this->getPortMonitorBlock('BW ASB (VRF)',array('host'=>'10.53.254.241','user'=>'root','pass'=>'asbbv'));
        ...
        $blocks_asb .= $this->getPortMonitorBlock('BW KPN (EHV)', array(
            'host' => '10.53.183.21'
        ), array(), array(
            'host' => '10.53.183.9',
            'user' => 'root',
        ...
        $blocks_asb .= $this->getPortMonitorBlock('BW HRH', array(
            'host' => '10.53.64.92'
        ));
        ...
        $blocks_gw .= $this->getPortMonitorAoip('AOIP gateway', array(
            'host' => '192.168.100.60',
            'user' => 'PreProcessorWEB',
            'pass' => 'asb',
            'db' => 'scs_fep'
        ));
